...
use Src\Application\Services\PowerSpecificPropertyService;

class PowerSpecificPropertyPresentationController
{
    private PowerSpecificPropertyService $service;

    public function __construct(PowerSpecificPropertyService $service)
    {
